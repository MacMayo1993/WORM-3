...
export const BET_TYPES = {
  SURVIVOR: {
    ...
    desc: 'Pick a face color in the final winning pair.',
    odds: 2.7,
    icon: 'S',
  },
  PAIR: {
    ...
    desc: 'Pick the opposite color pair that survives.',
    odds: 2.7,
    icon: 'P',
  },
  FIRST_OUT: {
    ...
    desc: 'Pick the first face color to lose all its tiles.',
    odds: 5.4,
    icon: 'F',
  },
  SPEED: {
    ...
    desc: 'Predict whether the time from first elimination to last is above or below the displayed threshold.',
    odds: 1.8,
    icon: 'Z',
  },
};
...
// scripts/measureSpeedOdds.mjs — 150 headless rounds per cell on a 3×3,
// after the 2026-07-16 flip-cap halving + per-tile contagion boost (see
// game/chaosSim.js — sourceCapProximity in chainTick).
