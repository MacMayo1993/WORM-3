...
const EXPECTED_KEYS = [
  'wormStoryLevel', 'wormStoryStarted', 'wormStoryReady', 'wormStoryTarget', 'wormStoryProgress', 'wormStoryResult', 'startWormStory', 'completeWormStory', 'claimWormStoryReward',
  ...
  'startWormDemoLesson', 'restartWormDemoLesson', 'nextWormDemoLesson', 'finishWormDemo',
  ...
  'hasFlippedOnce', 'hasShuffled',
  'hollowMode', 'incrementMoves', 'initWormMode',
  'kociembaLayerHighlight', 'lastBetResult', 'lastRotation', 'lerpShaderValues',
  'markIntroSeen', 'markMobileHintShown', 'markTutorialDone',
  'mirrorMode', 'modePlays',
  'moveHistory',
  'moves', 'ownedItems', 'parityCurrent', 'parityPoints',
  'parityTarget', 'pendingMove', 'perfReducedFX', 'popFromHistory',
  'randomMode', 'randomStyleTick', 'recordModePlay', 'refundActiveBet',
  'removeDisparityDeathsBulk',
  ...
  'setFlipWaveOrigins', 'setGameStartTime', 'setGameTime',
  'setHasFlippedOnce',
  'setHasShuffled', 'setHollowMode', 'setKociembaLayerHighlight',
  'setLastBetResult',
