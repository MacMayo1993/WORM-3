...
const EXPECTED_KEYS = [
  ...
  'chaosCurrent', 'chaosLevel', 'chaosStats', 'chaosTarget',
  ...
  'randomMode', 'randomStyleTick', 'refundActiveBet', 'resetGame',
  ...
  'setWormDeathDetails', 'setWormGamePhase', 'setWormHat', 'setWormHealedCount',
  ...
  'toggleTunnels', 'toggleWormControlMode', 'triggerCameraOrbit', 'tunnelBirths',
  'tunnelDeaths', 'tunnelDetail', 'tunnelPulses', 'upcomingRotation',
  'victory', 'visualMode', 'wormActiveTunnelColors', 'wormAlive',
  'wormBodyTiles', 'wormBoostState', 'wormCharacter', 'wormColor',
  'wormControlMode', 'wormCountdownStep', 'wormDeathDetails', 'wormGamePhase',
