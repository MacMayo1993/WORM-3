  ...
  return (
    <div className="bottom-nav-bar">
      ...
      <button
        ...
        title="Views"
      >
        <svg className="bottom-nav-icon" viewBox="0 0 24 24" fill="none" stroke={hasActiveView || viewsOpen ? '#FF9800' : 'rgba(200,220,255,0.55)'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <button
        ...
        title="More options"
      >
        <svg className="bottom-nav-icon" viewBox="0 0 24 24" fill="none" stroke={moreOpen ? '#e8edf8' : 'rgba(200,220,255,0.55)'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
