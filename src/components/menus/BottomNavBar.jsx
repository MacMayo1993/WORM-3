  ...
  return (
    <div className="bottom-nav-bar">
      ...
      <button
        ...
        title="Views"
      >
        <svg className="bottom-nav-icon" viewBox="0 0 24 24" fill="none" stroke={hasActiveView || viewsOpen ? '#FF9800' : 'rgba(15,23,42,0.45)'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <button
        ...
        title="More options"
      >
        <svg className="bottom-nav-icon" viewBox="0 0 24 24" fill="none" stroke={moreOpen ? '#334155' : 'rgba(15,23,42,0.45)'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
