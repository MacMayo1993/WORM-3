...
// ─── Cube stage ───────────────────────────────────────────────────────────────
// The measured viewport rectangle of the transparent DOM stage. The cube uses
// this to stay centered and in bounds as controls, disclosures or screens resize.
let _stage = null; // { left, top, width, height } in CSS px
