    ...
    <>
      ...
      <section className="settings-section">
        ...
        <p style={{ fontSize: '13px', color: 'rgba(255, 255, 255, 0.6)', marginBottom: '16px', lineHeight: '1.5' }}>
          Every 10 seconds, the color scheme and tile styles randomize automatically, and each cubelet gets its own random view style (classic, grid, sudoku, wireframe, glass) while you play.
        </p>
