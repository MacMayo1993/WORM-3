...
const TopMenuBar = ({
  ...
  // Callback ref for the slot that hosts the mobile ☰ action button, so it
  ...
  return (
    <div className="top-app-bar" style={chaosMode ? { flexWrap: 'wrap', height: 'auto', minHeight: '48px' } : {}}>
      ...
      <div className="top-bar-right">
        ...
        {/* Home for the mobile ☰ action button (MobileControls portals into it),
            so it sits in the bar next to the gear rather than floating over the
            scene. Renders nothing when there is no mobile menu to host. */}
        <span className="top-bar-action-slot" ref={actionSlotRef} />
      </div>
