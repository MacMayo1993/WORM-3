...
export const fieldGuide = { paper: FIELD_GUIDE_PAPER, border: FIELD_GUIDE_BORDER, ink: FIELD_GUIDE_INK, muted: FIELD_GUIDE_MUTED, moss: UI_MOSS, mossLight: UI_MOSS_LIGHT, cream: UI_CREAM, gold: UI_GOLD };
