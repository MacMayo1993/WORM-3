...
const DEMO_LEVEL_CONFIGS = {
  ...
  'flip-gateway': {
    type: 'cube',
    cubeSize: 3,
    // Stage 3 is intentionally a nearly solved cube: one antipodal sticker pair
    // has been flipped out of place. When the player flips this center tile pair
    // once, the whole cube solves, proving flips are not just visual/tunnel tools
    // but can be part of the solve itself.
    scrambleSequence: null,
    flipSequence: [
