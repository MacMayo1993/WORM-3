...
// Instanced worm body: head = smooth lerp, body segments = arc-length walk over
// the step-history ring. Handles character gaits, funnel/wind tunnel riding and LOD.
...
import { getWindWorldPosInto, isTileInSlice, makeTunnelCenterline, buildTunnelCenterlineInto, tunnelTToArc, getTunnelArcPosInto } from '../wormLogic.js';
import { WORM_LIFT, ORB_SEGMENT_GROWTH, STEPS_PER_TILE, BODY_BALL_SPACING, BASE_TAIL_LENGTH, MAX_TAIL } from './constants.js';
