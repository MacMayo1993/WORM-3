...
// Healer worm mode — the mode wrapper only. Drives the game-phase state machine
// (scramble → spawn → countdown → active hazard rotations → finalHealing → solved)
// and mounts the render subsystems, which live in ./healerWorm/ (one module per
// subsystem; extracted 2026-07 with no behavior change).

import React, { useRef, useEffect } from 'react';
import { useFrame } from '@react-three/fiber';
import { useGameStore } from '../hooks/useGameStore.js';
import { getStickerWorldPos } from '../game/coordinates.js';
import { hasActiveTunnels } from './tunnelRegistry.js';
import { setWormTurnCallback } from './wormTurnBridge.js';
import { WORM_LIFT, FACE_NORMALS, STEPS_PER_TILE, AUTO_ROTATE_WARNING, SCRAMBLE_STEPS, ACTIVE_ROTATE_INTERVAL, COUNTDOWN_STEP_DURATION } from './healerWorm/constants.js';
...
import { PowerupOrbs } from './healerWorm/PowerupOrbs.jsx';
import { WormholeRings } from './healerWorm/WormholeRings.jsx';
import { TunnelPortalFX } from './healerWorm/TunnelPortalFX.jsx';
import { SliceWarningLights } from './healerWorm/SliceWarningLights.jsx';
import { HeartBurstSystem, TunnelHealProgress } from './healerWorm/healEffects.jsx';
import { GlowWormAura, PortalGlow, OrbFlashSystem, ThunkEffect, CollisionGlow } from './healerWorm/effects.jsx';
