import { tunnelRidePointInto } from '../utils/tunnelRide.js';
...
// The worm and visible riding surface share exactly the same rounded route.
export const getTunnelArcPosSmoothInto = tunnelRidePointInto;
