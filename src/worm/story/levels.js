...
export const WORM_STORY_LEVELS = [
  ...
  { id: 11, title: 'Pocket Crawl', subtitle: 'The smallest cube. Every tile is a corner.', cubeSize: 2,
    ...
    kind: 'orbs', target: 10, colors: 6, orbsPerFace: 2, speed: 1.6, par: 50, limit: 90, points: 30 },
  { id: 12, title: 'Grid Lines', subtitle: 'Every tile wears its address.', cubeSize: 3,
    ...
    kind: 'tunnel', target: 3, orbsPerFace: 3, speed: 2, par: 65, limit: 120, points: 30 },
  ...
  { id: 14, title: 'Glass Carousel', subtitle: 'A see-through cube that will not sit still.', cubeSize: 3,
    goal: 'Collect 12 orbs and survive 5 layer turns on a 3×3 glass cube. Turns come every 9 seconds.',
    kind: 'rotation', target: 5, orbs: 12, orbsPerFace: 3, speed: 2.1, rotateEvery: 9, par: 80, limit: 140, points: 30 },
  ...
  { id: 33, title: 'Knife Edge', subtitle: 'The pocket cube, turning every 7 seconds.', cubeSize: 2,
    ...
    kind: 'rotation', target: 8, orbs: 10, orbsPerFace: 2, speed: 1.9, rotateEvery: 7, par: 90, limit: 150,
