...
export const WORM_STORY_LEVELS = [
  ...
  { id: 2, title: 'Through the Looking Glass', subtitle: 'Four different ways through.',
    goal: 'Traverse four different tunnel pairs one at a time. The marker points to an unvisited pair. Clear your tail to finish.',
  ...
  { id: 9, title: 'Under Siege', subtitle: 'Fight. Encircle. Turn danger into a route.',
    ...
    kind: 'mastery', cubeSize: 7, target: 4, orbs: 24, speed: 2.25, rotateEvery: 14, par: 325, limit: 515,
  ...
  { id: 10, title: 'Worm Ascendant', subtitle: 'Everything you learned. One restless cube.',
    ...
    kind: 'mastery', target: 6, orbs: 36, rotations: 8, speed: 2.4, rotateEvery: 11, par: 490, limit: 730,
