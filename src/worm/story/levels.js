...
export const WORM_STORY_LEVELS = [
  ...
  { id: 9, title: 'Under Siege', subtitle: 'Fight. Encircle. Turn danger into a route.',
    ...
    kind: 'mastery', cubeSize: 7, target: 4, orbs: 24, speed: 3, rotateEvery: 10, par: 240, limit: 380,
  ...
  { id: 11, title: 'Pocket Crawl', subtitle: 'The smallest cube. Every tile is a corner.', cubeSize: 2,
    goal: 'Collect 14 orbs, including all 6 colors, on the 2×2 pocket cube.',
    kind: 'orbs', target: 14, colors: 6, speed: 2.4, par: 45, limit: 90, points: 30 },
  { id: 12, title: 'Grid Lines', subtitle: 'Every tile wears its address.', cubeSize: 3,
    goal: 'Cross 3 different tunnel pairs on a 3×3 cube in Grid view. Clear your tail to finish.',
    kind: 'tunnel', target: 3, speed: 2.6, par: 50, limit: 100, points: 30 },
  { id: 13, title: 'Numbers Underfoot', subtitle: 'Numbers instead of colors. Same jumps.', cubeSize: 4,
    ...
    kind: 'jump', target: 3, orbs: 10, speed: 2.7, par: 65, limit: 120,
  ...
  { id: 14, title: 'Glass Carousel', subtitle: 'A see-through cube that will not sit still.', cubeSize: 3,
    goal: 'Collect 14 orbs and survive 6 layer turns on a 3×3 glass cube. Turns come every 7 seconds.',
    kind: 'rotation', target: 6, orbs: 14, speed: 2.8, rotateEvery: 7, par: 70, limit: 130, points: 30 },
  { id: 15, title: 'Chrome Works', subtitle: 'Six faces wide, polished to a mirror.', cubeSize: 6,
    ...
    kind: 'collector', target: 4, colors: 6, speed: 3, rotateEvery: 10, par: 130, limit: 210,
  ...
  { id: 16, title: 'Mind the Gap', subtitle: 'Seven layers, and space between every piece.', cubeSize: 7,
    ...
    kind: 'restore', target: 5, orbs: 24, rotations: 5, speed: 3.1, rotateEvery: 9, par: 180, limit: 290, points: 35 },
  { id: 17, title: 'Launch Pad', subtitle: 'Boost, bounce and fly on a tight board.', cubeSize: 4,
    ...
    kind: 'mastery', target: 2, orbs: 14, speed: 3, par: 120, limit: 210,
  ...
  { id: 18, title: 'Blast Radius', subtitle: 'Pull the cube apart and keep crawling.', cubeSize: 6,
    ...
    kind: 'mastery', target: 3, orbs: 20, speed: 3.1, rotateEvery: 11, par: 170, limit: 280,
  ...
  { id: 19, title: 'Neon Arcade', subtitle: 'Eight layers of light. Six ways through.', cubeSize: 8,
    ...
    kind: 'tunnel', target: 6, speed: 3.2, par: 150, limit: 250, points: 35 },
  { id: 20, title: 'Size Summit', subtitle: 'The biggest board yet. Every tool you own.', cubeSize: 8,
    ...
    kind: 'mastery', target: 4, orbs: 30, rotations: 6, speed: 3.2, rotateEvery: 9, par: 300, limit: 460,
  ...
  { id: 21, title: 'Hollow Hills', subtitle: 'Every piece is an open frame.', cubeSize: 5,
    ...
    kind: 'orbs', target: 20, colors: 6, speed: 3.1, par: 60, limit: 110, points: 35 },
  { id: 22, title: 'Ghost Frame', subtitle: 'No stickers. Only edges and tunnels.', cubeSize: 5,
    ...
    kind: 'tunnel', target: 4, speed: 3.1, par: 80, limit: 140, points: 35 },
  { id: 23, title: 'Brick by Brick', subtitle: 'A toy-brick cube with your tail across it.', cubeSize: 4,
    ...
    kind: 'jump', target: 4, orbs: 12, speed: 2.8, par: 80, limit: 140,
  ...
  { id: 24, title: 'Biome Crossing', subtitle: 'Lava, grass, ice and water faces.', cubeSize: 6,
    ...
    kind: 'mastery', target: 3, orbs: 18, speed: 3.2, rotateEvery: 10, par: 220, limit: 340,
  ...
  { id: 25, title: 'The Far Side', subtitle: 'Watch where your twins land.', cubeSize: 5,
    ...
    kind: 'restore', target: 4, orbs: 20, rotations: 4, speed: 3.2, rotateEvery: 9, par: 150, limit: 250,
  ...
  { id: 26, title: 'Remix', subtitle: 'The colors and tiles change every 10 seconds.', cubeSize: 5,
    ...
    kind: 'rotation', target: 6, orbs: 18, speed: 3.2, rotateEvery: 8, par: 90, limit: 160, points: 40 },
  { id: 27, title: 'Neon Storm', subtitle: 'Master three elements under neon light.', cubeSize: 6,
    ...
    kind: 'mastery', target: 3, orbs: 20, speed: 3.3, rotateEvery: 10, par: 240, limit: 380,
  ...
  { id: 28, title: 'Shatterglass', subtitle: 'Blow the glass cube apart, then fly.', cubeSize: 7,
    ...
    kind: 'mastery', target: 3, orbs: 24, speed: 3.3, rotateEvery: 10, par: 230, limit: 360,
  ...
  { id: 29, title: 'Number Siege', subtitle: 'Fight across a cube of numbers.', cubeSize: 7,
    ...
    kind: 'mastery', target: 4, orbs: 24, speed: 3.3, rotateEvery: 10, par: 260, limit: 400,
  ...
  { id: 30, title: 'Kaleidoscope', subtitle: 'Every view at once, and it keeps changing.', cubeSize: 6,
    ...
    kind: 'mastery', target: 5, orbs: 30, rotations: 6, speed: 3.4, rotateEvery: 8, par: 360, limit: 540,
  ...
  { id: 31, title: 'Nine Lives', subtitle: 'Nine layers. Six colors. Keep your tail.', cubeSize: 9,
    ...
    kind: 'orbs', target: 36, colors: 6, speed: 3.4, par: 130, limit: 220, points: 45 },
  { id: 32, title: 'Tenfold Tunnels', subtitle: 'Six ways through a ten-layer cube.', cubeSize: 10,
    ...
    kind: 'tunnel', target: 6, speed: 3.3, par: 170, limit: 280, points: 45 },
  { id: 33, title: 'Knife Edge', subtitle: 'The pocket cube, turning every 5 seconds.', cubeSize: 2,
    goal: 'Collect 16 orbs and survive 10 layer turns on a 2×2 cube in Gap view. Turns come every 5 seconds.',
    kind: 'rotation', target: 10, orbs: 16, speed: 2.8, rotateEvery: 5, par: 70, limit: 120,
  ...
  { id: 34, title: 'Chrome Gauntlet', subtitle: 'Nine polished layers that never stop turning.', cubeSize: 9,
    ...
    kind: 'restore', target: 6, orbs: 30, rotations: 6, speed: 3.3, rotateEvery: 7, par: 260, limit: 400, points: 50 },
  { id: 35, title: 'Hollow Siege', subtitle: 'Enemies and bombs inside an open frame.', cubeSize: 8,
    ...
    kind: 'mastery', target: 4, orbs: 24, speed: 3.4, rotateEvery: 10, par: 300, limit: 460,
  ...
  { id: 36, title: 'Ghost Storm', subtitle: 'Four elements on a cube with no stickers.', cubeSize: 6,
    ...
    kind: 'mastery', target: 3, orbs: 20, speed: 3.4, rotateEvery: 8, par: 250, limit: 380,
  ...
  { id: 37, title: 'Brick Blast', subtitle: 'Ten layers of bricks, blown apart three times.', cubeSize: 10,
    ...
    kind: 'mastery', target: 4, orbs: 30, speed: 3.3, rotateEvery: 10, par: 330, limit: 500,
  ...
  { id: 38, title: 'Mirror Numbers', subtitle: 'Numbers on this side. Twins on the far side.', cubeSize: 7,
    ...
    kind: 'restore', target: 6, orbs: 30, rotations: 8, speed: 3.3, rotateEvery: 6, par: 250, limit: 380,
  ...
  { id: 39, title: 'Mega Crawl', subtitle: 'Fifteen layers. The largest cube there is.', cubeSize: 15,
    ...
    kind: 'orbs', target: 40, colors: 6, speed: 3.5, par: 260, limit: 420, points: 75 },
  { id: 40, title: 'Worm Eternal', subtitle: 'Every size of trouble, every trick, one remixing cube.', cubeSize: 10,
    ...
    kind: 'mastery', target: 6, orbs: 40, rotations: 10, speed: 3.4, rotateEvery: 7, par: 480, limit: 720,
