...
export const WORM_STORY_LEVELS = [
  ...
  { id: 9, title: 'Under Siege', subtitle: 'Fight. Encircle. Turn danger into a route.',
    goal: 'Surround a tunnel to heal it, use your character signature twice, disarm one bomb by encircling it, defeat one enemy, collect 24 orbs and restore four pairs. Tunnel deposits seal after the ring and signature goals.',
