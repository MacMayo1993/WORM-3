import { accessoryPreviewEquipment } from '../worm/handmadeAccessoriesData.js';
...
export default function RewardPreview({ choice }) {
  ...
  if (item.type === 'skin' || item.type === 'hat' || item.type === 'accessory') return <WormPreviewCanvas accessories={accessoryPreviewEquipment(item)} characterId={character} skinId={item.skinId || skin} hatId={item.hatId || hat} size={220} animated={!prefersReducedMotion()} framing="character" maxRenderPixels={440} />;
