...
export const WORM_DEMO_LESSONS = [
  ...
  { id: 'signature', title: 'Your signature move', instruction: 'Press Trail. Glow Worm paints behind its tail for eight seconds. The trail stays for twelve more seconds. Enemies glow brighter.', success: 'Your signature has its own cooldown, separate from Boost.' },
