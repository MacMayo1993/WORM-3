...
export const WORM_DEMO_LESSONS = [
  ...
  { id: 'tunnel', title: 'Jump onto a flip pad', instruction: 'Face the raised tile ahead. Press JUMP to land on the marked pad and ride its tunnel. Walking underneath does not enter.', success: 'You rode the band and emerged from the opposite raised tile. With no matching charges, the tunnel stays open.' },
  ...
  { id: 'signature', title: 'Your signature move', instruction: 'Press Trail, then crawl until you see it painted behind your tail. Glow Worm paints for eight seconds; the trail stays for twelve more.', success: 'Your Light Trail is visible. Its cooldown is separate from Boost, and enemies glow brighter while it is active.' },
