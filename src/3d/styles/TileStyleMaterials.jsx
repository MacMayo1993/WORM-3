...
import { craftShaders } from './shaders/craftShaders.js';
...
if (import.meta.env.DEV) {
  const _shaderModules = [basicShaders, techShaders, natureShaders, opArtShaders, antipodalShaders, newStyleShaders, craftShaders];
  const _seen = new Map();
