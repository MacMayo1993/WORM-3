// Vendored from three.js examples/jsm/geometries/LoftGeometry.js (r185).
// Pulled in standalone rather than bumping the project's three.js pin —
// it's a plain BufferGeometry subclass with no WebGPU/TSL dependency.
import {
	BufferGeometry,
 ...
 *
 * `LoftGeometry` is the general case of geometries like `LatheGeometry`
 * (which revolves a fixed profile around an axis) or `TubeGeometry`
