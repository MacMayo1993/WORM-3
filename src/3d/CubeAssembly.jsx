...
import { updateSharedTime, updateSharedTremor, warmUpDefaultStyles, healEyelidMap } from './styles/TileStyleMaterials.jsx';
          ...
          if (store.chaosLevel > 0) {
            ...
            if (tapped && tapped.curr !== tapped.orig) {
              ...
              for (const t of toHeal) {
                ...
                if (ts) {
                  const gridId = getManifoldGridId(ts, size);
                  healEyelidMap.set(gridId, { fromFaceId: ts.curr, toFaceId: ts.orig });
                }
