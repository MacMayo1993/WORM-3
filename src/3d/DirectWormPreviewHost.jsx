...
import { borrowPreviewCanvas, getDirectWormPreview, subscribeDirectWormPreview } from './directWormPreview.js';
import { drawDirectWormPreview } from './WormPreviewRenderer.js';
import { prefersReducedMotion } from '../utils/device.js';

function ActivePreview({ entry }) {
...
export default function DirectWormPreviewHost() {
    ...
    return entry ? <ActivePreview entry={entry} /> : null;
}
